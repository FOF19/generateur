...
let citations = [
  ...
  let bnt=document.getElementById('nouveau');
  bnt.addEventListener('click',()=>{
    do{
      nombreAleatoire= geneNombreA(citations.length)
     
    }while(nombreAleatoire==dernier)

    cit.textContent=citations[nombreAleatoire][0];
